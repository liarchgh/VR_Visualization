...
//				GlobalVariableBackground.Instance.conManager.WriteLog(handler.Method + " - " + callingFrame.GetMethod() + " - " + callingFrame.GetMethod().ReflectedType + ": " + callingFrame.GetFileLineNumber());
				handler();
			}
		}
	}
